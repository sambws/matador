...
public class TextManager extends Entity{
	 ...
	 * SHITBOY WALKS OVER THE NPC, HIS CURRENT NPC VARIABLE GETS SET TO THAT NPC (found in shitboy's code)
	 * SHITBOY PRESSES X -> TEXT INITS AND IS TAKEN FROM THE NPC TEXT VARIABLE INTO THE TXTMANAGER TEXT VARIABLE (FOR DISPLAYING) (found in textmanager)
